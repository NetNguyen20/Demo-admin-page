                                        ...
                                        <div class="modal-content">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="product_name" required value="">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Product price</label>
                                                            <input type="text" class="form-control" id="product_price" required value="">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Product description</label>
                                                            <input type="text" class="form-control" id="product_description" required value="">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Product brand</label>
                                                            <input type="text" class="form-control" id="product_brand" required value="">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                <div class="form-group mt-1" id="nonloading">
                                                    <button type="button" onclick="addproduct()" class="btn btn-primary">Add new</button>
                                                </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Product price</label>
                                                            <input type="text" class="form-control" id="update_price" required value="">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Product description</label>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Product brand</label>
                                                            <input type="text" class="form-control" id="update_brand" required value="">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                <div class="form-group mt-1" id="nonloading_upd">
                                                    <button type="button" onclick="update_product()" class="btn btn-primary">Update</button>
                                                </div>
